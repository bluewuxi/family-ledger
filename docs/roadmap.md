...
- Scheduled execution policy (implemented: EventBridge Scheduler runs FX, price, and snapshot jobs after the `09:00 Asia/Shanghai` business-day cutoff with retry attempts `2` and maximum event age `1 hour`)
