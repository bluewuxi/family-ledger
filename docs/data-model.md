...
Portfolio snapshots are durable daily valuation records generated by scheduled jobs or manual backfills. The app business day uses a `09:00 Asia/Shanghai` cutoff so snapshot dates are stable across viewer time zones.
