...
- Additional price maintenance and automated instrument price updates (implemented for configured providers; provider expansion deferred)
- Price-source adapters for `yahoo_finance` and `eastmoney` (implemented for enabled instruments)
